$(document).ready(function(e){
    ...
    $("#submit-btn").on("click", function(e) {
        ...
        if (message == "" || message == null){
            $("#msgErr").html("Describe your business requirements");
...
function submitFeedback(formData) {
    $.ajax({
        url: "http://xyz.com/webServices/businessEnquiry.php",
        type: "POST",
        dataType: "json",
        crossDomain: true,
        cache: false,
        ...
        success: function() {
            swal({
                ...
                text: "Thank you for submitting your business requirements. We will get back to you shortly.",
                type: "success",
