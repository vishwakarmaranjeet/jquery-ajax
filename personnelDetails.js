				...
				if (data.status === "success") {
					...
					for (var i = 0; i < data.details.length; ++i) {
						...
						if (data.details[i].IsNominee == 'Y') {
							output += "<div class='col s12 center' style='background:#f4f4f4;><h5 class='white-text'><i class='fa fa-check-circle'></i> Nominee</h5></div>";
						}
						output += "<div class='col s12' style='background:#f4f4f4;'><a style='color:#333;' href='edit-personnel-information.html?pid=" + data.details[i].PersonnelID + "' class='edit-text'><i class='fa fa-edit'></i> EDIT PROFILE</a></div>";
